// Remove duplicate React import - keep only one
...
const setupTextHover = (container, type) => {
    ...
    const handleMouseMove = (e) => {
        ...
        letters.forEach(letter => {
            ...
            const distance = Math.abs(mouseX - (letterLeft + width / 2));
...
function Welcome() {
    ...
    return (
        <section id="welcome">
            <p ref={subtitleRef}>
                {renderText("Hey,I'm Zeeshan! Welcome to my", 'text-3xl font-georama', 100)}
            </p>
